            ...
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-2xl mx-auto flex items-center bg-white rounded-full shadow-lg p-2">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="bg-primary-teal text-white rounded-full px-8 py-4 font-semibold hover:bg-teal-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center"
                    >
                        {isLoading ? (
